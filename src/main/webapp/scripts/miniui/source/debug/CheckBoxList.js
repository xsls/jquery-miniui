 ...
 * 
 *     @example
 *     &lt;div id="cbl1" class="mini-checkboxlist" repeatItems="2" repeatLayout="table" textField="text" valueField="id" value="cn,usa" onload="onLoad" url="../data/countrys.txt" &gt;&lt;/div&gt;
 * 
 * @class
